...
export default function PremiumInteractiveForm({
  ...
  return (
    <motion.form
      ...
      className={`group ${baseForm} shadow-[var(--shadow-card)] transition-[box-shadow,border-color] duration-[520ms] [transition-timing-function:cubic-bezier(0.16,1,0.32,1)] hover:border-black/[0.07] hover:shadow-[var(--shadow-card-hover)] ${className}`}
      {...rest}
    >
      <div
