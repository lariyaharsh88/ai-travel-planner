...
/** Airbnb-style lift + shadow bloom; Apple-style ease. Respects reduced motion. */
export default function PremiumInteractiveCard({
  ...
  return (
    <motion.div
      ...
      className={`group ${baseCard} shadow-[0_10px_40px_-18px_rgba(15,23,42,0.1)] transition-[box-shadow,border-color] duration-[520ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] hover:border-stone-200/90 hover:shadow-[0_32px_72px_-22px_rgba(15,23,42,0.15),0_0_0_1px_rgba(255,107,53,0.06)] ${className}`}
      {...rest}
    >
      <div
