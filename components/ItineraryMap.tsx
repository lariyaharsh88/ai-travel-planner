...
/** Spread pins that share the same rounded coordinates so every stop stays visible */
...
export default function ItineraryMap({ route, destination }: ItineraryMapProps) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#0c1829]/12 shadow-inner">
      <div className="h-[min(22rem,70vh)] min-h-[352px] w-full sm:h-[26rem] sm:min-h-[416px] [&_.leaflet-control-zoom]:border-[#0c1829]/15">
      ...
      <div className="flex flex-col gap-2 border-t border-stone-100/90 bg-white px-3 py-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-3">
        ...
        {isLoadingMap ? <p className="text-sm text-[#64748b]">Placing pins…</p> : null}
